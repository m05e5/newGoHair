...
class LoginCoiffeur extends StatefulWidget {
  LoginCoiffeur({Key key}) : super(key: key);
  final String title = 'Connexion';

  @override
  _LoginCoiffeurState createState() => _LoginCoiffeurState();
}

class _LoginCoiffeurState extends State<LoginCoiffeur> {
  @override
...
class LoginCForm extends StatefulWidget {
  @override
  _LoginCFormState createState() => _LoginCFormState();
}

class _LoginCFormState extends State<LoginCForm> {
 ...
 void _togglePasswordVisibility() {
  ...
  void _login(BuildContext context) async {
    if (_formKey.currentState.validate()) {
      ...
      AuthResult result = await _auth_C.signInWithEmailAndPassword(email: _email, password: _password);
